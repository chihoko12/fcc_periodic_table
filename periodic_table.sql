...
--
-- Name: format_atomic_mass(numeric); Type: FUNCTION; Schema: public; Owner: freecodecamp
--

CREATE FUNCTION public.format_atomic_mass(am numeric) RETURNS text
    LANGUAGE plpgsql IMMUTABLE
    AS $$
BEGIN
    RETURN TRIM(TRAILING '0' FROM TRIM(TRAILING '.' FROM TO_CHAR(am, '999999999D999999999')));
END;
$$;


ALTER FUNCTION public.format_atomic_mass(am numeric) OWNER TO freecodecamp;
...
INSERT INTO public.properties VALUES (10, 20.180000, -248.16, -246.1, 1);
